...
By creating these tables, it will be easier to match this information to other
datasets, such as the 
[Environmental Protection Agency's Enforcement and Compliance History Online (ECHO)](https://echo.epa.gov/) 
database. For example, without extracting the NPDES ID, it would not be possible
to look up the relevant permit information in ECHO. 
