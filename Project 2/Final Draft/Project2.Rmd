...
2.  **Dataset #2: Public Transport Data (DART 2020-2025)**

-   **Description**: This dataset contains public transport schedules and service availability from 2020 to 2025.
-   **Data Issues**: The dataset is not normalized, and some entries are duplicated.
-   **Transformation Steps**: We will standardize date formats, remove redundant data, and ensure consistency across service records.
...
## By applying tidy data principles, we ensure that each dataset is structured, organized, and ready for analysis. The insights gained from this project can be used for policy recommendations, transportation planning, and nutritional analysis.
...
# Export cleaned DART Transportation dataset
...
2.  **DART Transportation Data:**

    -   The dataset was transformed to facilitate trend analysis in public transportation usage from 2020 to 2025.
