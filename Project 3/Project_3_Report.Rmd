...
soc_industry_project_df_change_clean <- soc_industry_project_change_df |> 
  drop_na() |> 
...
soc_industry_project_df_change_clean_summ <- summary(soc_industry_project_df_change_clean)
...
list(
  ...
  soc_industry_project_df_change_clean_summ = soc_industry_project_df_change_clean_summ
)
```
...
knit_table(head(soc_industry_project_df_change), 'Preview Cleaned soc_industry_project_df')
```
...
# password <- Sys.getenv("OliviaStrongPass123!")
