...
## Logical Model 
To create the logical model, the [ReDaMoR](https://cran.r-project.org/web/packages/ReDaMoR/vignettes/ReDaMoR.html#1_Introduction) 
R Package can be used. Logical models [insert purpose here].
